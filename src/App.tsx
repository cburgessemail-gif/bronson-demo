...
import {
  ArrowRight, ArrowLeft, Home, Users, ShoppingBasket, Tractor,
  GraduationCap, Handshake, MapPin, Globe2, CheckCircle,
...
type TourStepKey =
  | "welcome" | "place" | "problem" | "solution"
  | "guest" | "customer" | "marketplace" | "grower"
  | "youth" | "partners" | "future" | "ending";
...
const imageSets: Record<PathwayKey | "hero" | TourStepKey, string[]> = {
  ...
  solution: ["/ConnectFoodEcosystem_withimages.jpeg", "/SAM_0257.JPG", "/SAM_0260.JPG"],
...
const UI: Record<Lang, any> = {
  en: {
    ...
    heroText: "A guided ecosystem experience showing how land, growers, food, youth workforce, community partners, and future agritourism work together.",
    startTour: "Start Guided Tour", pauseTour: "Pause", resumeTour: "Resume",
    narrationOn: "Narration On", narrationOff: "Turn Narration On",
    explorePathways: "Explore Pathways", guidedTour: "Guided Tour",
    step: "Step", of: "of", back: "Back", next: "Next",
    replay: "Replay Guided Tour", pathwaysEyebrow: "Explore the Ecosystem",
    pathwaysTitle: "Pathways Through the Farm",
    pathwaysIntro: "Every pathway represents a different role inside the ecosystem. Together they create a connected regional system focused on food accessibility, grower support, workforce development, and sustainability.",
    enterPathway: "Enter Pathway", activePathway: "Active Pathway",
    continueTour: "Continue Guided Tour",
    endingTitle: "End of Experience",
    endingBody: "Bronson Family Farm demonstrates how food, agriculture, growers, education, youth workforce, community wellness, and economic sustainability can work together through one intentional ecosystem.",
  },
  es: {
    location: "Aeropuerto Histórico Lansdowne · Youngstown, Ohio",
    demoTitle: "Bronson Family Farm",
    heroText: "Una experiencia guiada que muestra cómo la tierra, los productores, los alimentos, la fuerza laboral juvenil, los socios comunitarios y el futuro agroturismo trabajan juntos.",
    startTour: "Iniciar recorrido guiado", pauseTour: "Pausar", resumeTour: "Continuar",
    narrationOn: "Narración activada", narrationOff: "Activar narración",
    explorePathways: "Explorar caminos", guidedTour: "Recorrido guiado",
    step: "Paso", of: "de", back: "Atrás", next: "Siguiente",
    replay: "Repetir recorrido", pathwaysEyebrow: "Explorar el ecosistema",
    pathwaysTitle: "Caminos a través de la granja",
    pathwaysIntro: "Cada camino representa un papel dentro del ecosistema. Juntos crean un sistema regional conectado enfocado en acceso a alimentos, apoyo a productores, desarrollo laboral y sostenibilidad.",
    enterPathway: "Entrar al camino", activePathway: "Camino activo",
    continueTour: "Continuar recorrido",
    endingTitle: "Fin de la experiencia",
    endingBody: "Bronson Family Farm demuestra cómo alimentos, agricultura, productores, educación, juventud, bienestar comunitario y sostenibilidad económica pueden trabajar juntos.",
  },
  tl: {
    location: "Historic Lansdowne Airport · Youngstown, Ohio",
    demoTitle: "Bronson Family Farm",
    heroText: "Isang guided ecosystem experience na nagpapakita kung paano nagtutulungan ang lupa, growers, pagkain, youth workforce, partners, at future agritourism.",
    startTour: "Simulan ang guided tour", pauseTour: "I-pause", resumeTour: "Ipagpatuloy",
    narrationOn: "Naka-on ang narration", narrationOff: "I-on ang narration",
    explorePathways: "Tingnan ang pathways", guidedTour: "Guided Tour",
    step: "Hakbang", of: "ng", back: "Balik", next: "Susunod",
    replay: "Ulitin ang tour", pathwaysEyebrow: "Tuklasin ang ecosystem",
    pathwaysTitle: "Mga pathway sa farm",
    pathwaysIntro: "Bawat pathway ay may papel sa ecosystem. Sama-sama nilang binubuo ang sistema para sa food access, grower support, workforce development, at sustainability.",
    enterPathway: "Pumasok sa pathway", activePathway: "Active pathway",
    continueTour: "Ipagpatuloy ang guided tour",
    endingTitle: "Katapusan ng experience",
    endingBody: "Ipinapakita ng Bronson Family Farm kung paano nagsasama ang pagkain, agriculture, growers, education, youth workforce, wellness, at sustainability.",
  },
  it: {
    location: "Aeroporto Storico Lansdowne · Youngstown, Ohio",
    demoTitle: "Bronson Family Farm",
    heroText: "Un’esperienza guidata che mostra come terra, coltivatori, cibo, giovani, partner comunitari e futuro agriturismo lavorano insieme.",
    startTour: "Avvia tour guidato", pauseTour: "Pausa", resumeTour: "Riprendi",
    narrationOn: "Narrazione attiva", narrationOff: "Attiva narrazione",
    explorePathways: "Esplora percorsi", guidedTour: "Tour guidato",
    step: "Passo", of: "di", back: "Indietro", next: "Avanti",
    replay: "Ripeti tour", pathwaysEyebrow: "Esplora l’ecosistema",
    pathwaysTitle: "Percorsi attraverso la fattoria",
    pathwaysIntro: "Ogni percorso rappresenta un ruolo nell’ecosistema. Insieme creano un sistema regionale connesso per accesso al cibo, supporto ai coltivatori, formazione e sostenibilità.",
    enterPathway: "Entra nel percorso", activePathway: "Percorso attivo",
    continueTour: "Continua tour guidato",
    endingTitle: "Fine dell’esperienza",
    endingBody: "Bronson Family Farm dimostra come cibo, agricoltura, coltivatori, educazione, giovani, benessere comunitario e sostenibilità possano lavorare insieme.",
  },
  he: {
    location: "שדה התעופה ההיסטורי Lansdowne · יאנגסטאון, אוהיו",
    demoTitle: "Bronson Family Farm",
    heroText: "חוויה מודרכת שמראה כיצד אדמה, מגדלים, מזון, נוער, שותפים קהילתיים ותיירות חקלאית עתידית פועלים יחד.",
    startTour: "התחל סיור מודרך", pauseTour: "השהה", resumeTour: "המשך",
    narrationOn: "קריינות פעילה", narrationOff: "הפעל קריינות",
    explorePathways: "חקור מסלולים", guidedTour: "סיור מודרך",
    step: "שלב", of: "מתוך", back: "חזור", next: "הבא",
    replay: "הפעל מחדש", pathwaysEyebrow: "חקור את המערכת",
    pathwaysTitle: "מסלולים דרך החווה",
    pathwaysIntro: "כל מסלול מייצג תפקיד במערכת. יחד הם יוצרים מערכת אזורית המחזקת נגישות למזון, תמיכה במגדלים, פיתוח כוח עבודה וקיימות.",
    enterPathway: "כניסה למסלול", activePathway: "מסלול פעיל",
    continueTour: "המשך סיור מודרך",
    endingTitle: "סיום החוויה",
    endingBody: "Bronson Family Farm מדגימה כיצד מזון, חקלאות, מגדלים, חינוך, נוער, בריאות קהילתית וקיימות כלכלית עובדים יחד.",
  },
  fr: {
    location: "Aéroport historique de Lansdowne · Youngstown, Ohio",
    demoTitle: "Bronson Family Farm",
    heroText: "Une expérience guidée montrant comment la terre, les producteurs, l’alimentation, les jeunes, les partenaires et l’agritourisme futur travaillent ensemble.",
    startTour: "Commencer la visite guidée", pauseTour: "Pause", resumeTour: "Reprendre",
    narrationOn: "Narration activée", narrationOff: "Activer la narration",
    explorePathways: "Explorer les parcours", guidedTour: "Visite guidée",
    step: "Étape", of: "sur", back: "Retour", next: "Suivant",
    replay: "Rejouer la visite", pathwaysEyebrow: "Explorer l’écosystème",
    pathwaysTitle: "Parcours dans la ferme",
    pathwaysIntro: "Chaque parcours représente un rôle dans l’écosystème. Ensemble, ils créent un système régional connecté axé sur l’accès alimentaire, le soutien aux producteurs, les jeunes et la durabilité.",
    enterPathway: "Entrer dans le parcours", activePathway: "Parcours actif",
    continueTour: "Continuer la visite",
    endingTitle: "Fin de l’expérience",
    endingBody: "Bronson Family Farm montre comment alimentation, agriculture, producteurs, éducation, jeunesse, bien-être communautaire et durabilité économique peuvent fonctionner ensemble.",
  },
};

const pathwayBase: Pathway[] = [
  {
    key: "guest", title: "Guest Experience", icon: Home,
  ...
  {
    key: "customer", title: "Customer Pathway", icon: Users,
    short: "Customers access fresh, chemical-free food through a coordinated system focused on nutrition and community health.",
    purpose: "Customers do not have to chase food across disconnected places. The ecosystem helps move food toward families, schools, businesses, and community partners.",
    depth: [
  ...
  {
    key: "marketplace", title: "Marketplace", icon: ShoppingBasket,
  ...
  {
    key: "grower", title: "Grower Pathway", icon: Tractor,
  ...
  {
    key: "youth", title: "Youth Workforce", icon: GraduationCap,
...
const tourSteps: TourStep[] = [
  {
    key: "welcome", label: "Opening", title: "Welcome to Bronson Family Farm",
  ...
  {
    key: "place", label: "Place", title: "Historic Lansdowne Airport",
    body: "Bronson Family Farm is being developed at the Historic Lansdowne Airport on Youngstown’s east side. Aviation infrastructure is becoming food infrastructure, transforming land into a regenerative agricultural and community destination.",
    bullets: [
  ...
  {
    key: "problem", label: "Need", title: "Food Access, Health, and Economic Pressure",
  ...
  {
    key: "solution", label: "Solution", title: "The Connected Food Ecosystem",
  ...
  {
    key: "future", label: "Future", title: "Future Agritourism Destination",
  ...
  {
    key: "ending", label: "End", title: "A Model for Community Regeneration",
...
function SmartImage({
  srcs, alt, className, contain = false,
}: {
  srcs: string[];
  alt: string;
  className?: string;
  ...
  useEffect(() => setIndex(0), [srcs.join("|")]);
...
export default function App() {
  ...
  const activeData = useMemo(
    () => pathwayBase.find((p) => p.key === activePathway),
    [activePathway]
  );

  const imageContain = currentStep.key === "solution" || currentStep.key === "ending";
  ...
  return (
    <main className="min-h-screen bg-black text-white" dir={isHebrew ? "rtl" : "ltr"}>
              ...
              <div>
                ...
                <ul className="mt-6 space-y-3">
                  {currentStep.bullets.map((item) => (
                    <li key={item} className="flex gap-3 text-base leading-7 text-white/85">
        ...
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-3">
          {pathwayBase.map((p) => {
            ...
            return (
              ...
              >
                <SmartImage srcs={imageSets[p.key]} alt={p.title} className="h-64 w-full" />

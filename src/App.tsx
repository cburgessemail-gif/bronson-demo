      ...
      {activeView === "home" ? (
        ...
        <main>
          ...
          <section className="contentGrid">
            <article className="panel large"><p>{current.sound}</p></article>
            <article className="panel"><p>{current.intro}</p></article>
            <article className="panel"><p>{current.knowledge}</p></article>
            <article className="panel large"><p>{current.purpose}</p></article>
          </section>
                ...
                {marketItems.map((item) => (
                  <div className="marketCard" key={item.title}>
                    ...
                    <div className="marketBody">
                      ...
                      <h3>{item.title}</h3>
                      <p>{item.price}</p>
                      <button onClick={() => go(item.title.includes("Seed") || item.title.includes("Produce") || item.title.includes("Tomato") ? "customer" : "grower")}>
                        Learn More
                      </button>
                    </div>
                  </div>
...
.heroOverlay { position: absolute; inset: 0; background: linear-gradient(90deg, rgba(14,35,24,.55), rgba(14,35,24,.25), rgba(14,35,24,.10)); }

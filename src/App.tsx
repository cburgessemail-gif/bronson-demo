...
FINAL STABILIZED APP.TSX
NO REBUILDS
NO LAYOUT RECREATIONS
========================================================
...
GrowArea.jpg
= HERO aerial / beautiful farm overview

FarmEntrance.jpg
= welcoming entrance / pathway / farm experience

FreshProduce.jpg
= vegetables / produce / healthy food

MarketplaceProduce.jpg
= market tables / produce stand / abundance

Seedlings.jpg
= seedlings / hands growing / grow rows

YouthWorkforce.jpg
= REAL PEOPLE working outdoors

CommunityPartners.jpg
= collaboration / community gathering

ValueAddedProducer.jpg
= canning / packaged goods / food prep
...
const images = {
  ...
  partners:
    "/images/CommunityPartners.jpg",

  value:
    "/images/ValueAddedProducer.jpg",

  donor:
    "/images/FarmCommunity.jpg",
};
...
const pathways = [
...

  {
    ...
    label: "Marketplace",
    title:
      "Local Food Creates Local Strength.",
    icon: ShoppingBasket,
...

  {
    ...
    label: "Grower",
    title:
      "Unused Land Can Become Community Infrastructure.",
    icon: Sprout,
    image: images.grower,
    supporting:
...

  {
    ...
    title:
      "Outdoor Work Becomes Confidence.",
...

  {
    ...
    label: "Investment",
    title:
      "An Investment In Food Security Is An Investment In Community Health.",
    icon: HandHeart,
    image: images.donor,
    supporting:
    ...
    >
      ...
      <header className="sticky top-0 z-50 border-b border-[#d9cfbb] bg-[#F5F1E6]/95 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          <div>
            <h1 className="text-2xl font-black text-[#173C2D]">
              Bronson Family Farm
            </h1>

            <p className="text-xs font-bold uppercase tracking-[0.2em] text-[#7b705f]">
        ...
        <div className="relative mx-auto flex min-h-[760px] max-w-7xl items-center px-6 py-24">
          ...
          >
            ...
            <p className="mt-8 max-w-3xl text-2xl leading-10 text-white/90">
              ...
              throughout Youngstown and
              Mahoning County.
            </p>

            <div className="mt-10 flex flex-wrap gap-4">
              <button className="rounded-full bg-[#E7D7A3] px-7 py-4 text-lg font-black text-[#173C2D] transition hover:bg-white">
                Begin Guided
                Experience
              </button>
                ...
                <button
                  ...
                  className={cx(
                    ...
                    activePathway.id ===
                      ...
                      : "bg-white text-[#173C2D] shadow-lg"
                  )}
                >
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <div className="flex flex-col justify-center rounded-[40px] bg-white p-12 shadow-2xl">
              ...
              <h3 className="mt-5 text-6xl font-black leading-[1] tracking-tight text-[#173C2D]">
                {
                  activePathway.title
                }
              </h3>
              ...
              <div className="mt-10 flex flex-wrap gap-4">
                <button className="rounded-full bg-[#173C2D] px-7 py-4 font-black text-white transition hover:bg-[#2b5d47]">
                  Continue Guided
                  Experience
                </button>
      ...
      <section className="bg-[#F5F1E6] px-6 py-24">
        <div className="mx-auto max-w-7xl">
          ...
          <h2 className="mt-5 text-6xl font-black leading-tight text-[#173C2D]">
            Collaboration
            Strengthens
            Communities.
          </h2>
      ...
      <section className="bg-gradient-to-br from-[#10281d] via-[#173C2D] to-[#2a241b] px-6 py-28 text-white">
        <div className="mx-auto max-w-5xl text-center">
          ...
          <h2 className="mt-6 text-7xl font-black leading-[0.95] tracking-tight">
            This Is More Than
            A Farm.
          </h2>
          ...
          <div className="mt-12 flex flex-wrap justify-center gap-4">
            <button className="rounded-full bg-[#E7D7A3] px-8 py-4 text-lg font-black text-[#173C2D] transition hover:bg-white">
              Support Food
              Security
            </button>

    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <NavPill active={page === "home"} onClick={() => setPage("home")}>
              Home
            </NavPill>
            <NavPill active={page === "story"} onClick={() => setPage("story")}>
              Our Story
            </NavPill>
            {pathways.map((p) => (
              <NavPill
        ...
        {page === "home" && (
          <div style={{ marginTop: 28 }}>
            <div
              style={{
                background: gradient("#083827", "#0e704d"),
                borderRadius: 36,
                padding: 40,
                color: "#fff",
                boxShadow: softShadow("rgba(0,0,0,0.18)"),
            ...
            >
              ...
              >
                ...
                <div className="double-grid" style={{ display: "grid", gap: 20 }}>
          ...
          <div style={{ marginTop: 28 }}>
            ...
            >
              ...
              >
                ...
                <div className="double-grid" style={{ display: "grid", gap: 16 }}>
